...
var app = angular.module('angularDropdownList',[])

app.directive('dropdownList', function($compile) {
	return {
		template: function(element, attrs) {
			...
			if(listValue==""||listValue==null) listValue = listDisplay;
			if(dropdownClass==""||dropdownClass==null) dropdownClass = 'selection';
			if(placeholder==""||placeholder==null) placeholder = 'Select';		
			if(dropdownIcon==""||dropdownIcon==null) dropdownIcon = 'dropdown';		
			if(listStyle!=""&&listStyle!=null) listStyle = 'style = "'+listStyle+'"';
			if(dropdownStyle!=""&&dropdownStyle!=null) dropdownStyle = 'style = "'+dropdownStyle+'"';
