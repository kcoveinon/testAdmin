(function() {
    var managePartnersController = angular.module('manage-partners-controller', []);

    managePartnersController.controller("managePartnersController", ['$scope', 'B2BModalService', function(scope, b2bModalService) {
            ...
            scope.mainModal = b2bModalService.getMainModalSettings();
            scope.subModal = b2bModalService.getSubModalSettings();
            ...
            */
            ...
            scope.mainModal = {
                title:"Edit Company",
                contentLink:"testing2",
                actions:[
                    {name:"Close",directive:"",class:"negative"},
                    {name:"Update Company",directive:"edit-company-action",class:"blue"}
                ]
            }
            */
            ...
            scope.column_variable = [
                ...
                },
                {
                    ...
                    append: true,
                    content: '<div class="ui tiny button" company-action="edit" company-id="[[row.VVVCompanyID]]">Edit</div> <div class="ui tiny button">Delete</div>',
                    width: '14%'
                }
            ];
...
//        },
                ...
                },
                {
                    ...
                    content: '<div class="ui tiny button" manual-change-page="theme-builder/index/[[row.VVVSiteID]]">Theme Builder</div> <div class="ui tiny button" site-action="edit" company-id="[[row.VVVCompanyID]]" site-id="[[row.VVVSiteID]]">Edit</div> <div class="ui tiny button">Delete</div>',
                    width: '35%'
                }
            ];
